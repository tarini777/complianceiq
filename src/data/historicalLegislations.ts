/**
 * Static Historical Legislations Data - ComplianceIQ System
 * This data is static and doesn't change frequently, so it can be imported directly
 */
...
// Static historical legislations data
